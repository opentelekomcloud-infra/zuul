...
class TestUploadPlanner(BaseTestCase):
    ...
    def test_import_copy(self):
        ...
        self.assertEqual(
            [upload_copy.uuid],
            [get_uuid(x) for x in planner.import_jobs[0][1].dependents])
    ...
    def test_upload_copy(self):
        ...
        self.assertEqual(
            [upload_copy.uuid],
            [get_uuid(x) for x in planner.upload_jobs[0][1].dependents])
    ...
    def test_multi_import_copy(self):
        ...
        self.assertEqual(
            [upload_copy1.uuid],
            [get_uuid(x) for x in planner.import_jobs[1][1].dependents])
    ...
    def test_multi_upload_copy(self):
        ...
        self.assertEqual(
            [upload_copy1.uuid],
            [get_uuid(x) for x in planner.upload_jobs[1][1].dependents])
