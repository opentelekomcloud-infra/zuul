...
class AwsDeleteStateMachine(statemachine.StateMachine):
    ...
    def __init__(self, endpoint, node, log):
        ...
        self.aws_instance_id = node.aws_instance_id
        self.aws_dedicated_host_id = node.aws_dedicated_host_id
...
class AwsSnapshotStateMachine(statemachine.StateMachine):
    ...
    def __init__(self, endpoint, node, tags, log):
        super().__init__(node.snapshot_info)
        self.log = log
        self.endpoint = endpoint
