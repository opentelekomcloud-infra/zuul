...
class Executor(zuul.cmd.ZuulDaemonApp):
    ...
    def createParser(self):
        ...
        statsParsers = parser.add_subparsers(
            title='Stats commands',
            description=('The following commands may be used to gain '
                         'insight on the status of the executor.')
        )
        jobsStatsCmd = statsParsers.add_parser(
            'jobs-stats',
