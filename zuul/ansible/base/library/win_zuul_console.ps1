...
# This module embeds a near-copy of the zuul_console python module.
# That aids in maintainability since we can make identical changes to
# both modules as the console log streaming protocol evolves.  This
# module also needs to start a new process in order to separate from
# the sshd process, so that process may as well be python.  We could
# reimplement the entire console streamer in powershell and avoid the
# python dependency (but perhaps not the embedded script).
...
$LOG_STREAM_FILE = "C:/Users/All Users/Zuul/console-{0}.log"
