...
class AuthorizationRoleParser(object):
    ...
    def getSchema(self):
        authRole = {vs.Required('name'): str,
                    # TODO make this schema more strict
                    vs.Required('permissions'): dict,
                   }
...
class ApiRootParser(object):
    ...
    def validateRoleMappings(self):
        # Need to check that each key is a valid authz rule name
...
class ConfigLoader(object):
    ...
    def loadAuthzRules(self, abide, unparsed_abide):
        ...
        for conf_authz_role in unparsed_abide.authz_roles:
            ...
            abide.authz_roles[authz_rule.name] = authz_role
