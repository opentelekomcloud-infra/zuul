...
class ChangeKey:
    ...
    def __init__(self, connection_name, project_name,
        ...
        # FIXME(swest): make this work with json_dumpb
        # self.reference = json_dumpb(reference, sort_keys=True)
    ...
    def fromReference(cls, data):
        # FIXME(swest): make this work with json_loadb
...
class AbstractChangeCache(ZooKeeperSimpleBase, Iterable, abc.ABC):
    ...
    def set(self, key, change, version=-1):
        ...
        raw_data = json_dumpb(data, sort_keys=True)
