...
There will be no restriction on the use of dependencies by or against
initializer jobs: users will be free to construct explicit
dependencies in the usual manner.
