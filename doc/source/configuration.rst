...
.. attr:: oidc
   ...
   .. attr:: supported_signing_algorithms
      ...
      Algorithms that should be supported for signing the ID tokens, a string
      of algorithm names separated by ``,``. Currently ``RS256`` is supported.

   .. attr:: default_signing_algorithm
      :default: RS256

      The default algorithm used for signing the ID tokens if not specified in
